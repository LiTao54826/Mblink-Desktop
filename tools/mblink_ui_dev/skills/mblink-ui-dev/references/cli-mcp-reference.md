...
mblink-ui-dev click ...
mblink-ui-dev input-text <selector> <text>
mblink-ui-dev input-text <selector> --text <text>
mblink-ui-dev input-text <selector> --clear
...
- `input_text` supports clearing existing content and optional submit behavior. For CLI automation, prefer `input-text <selector> --clear` when the intended text is empty because some shells do not preserve an empty positional argument.
