# CMake 脚本：将 app_loader.exe 转换为 C++ 字节数组
# 用法: cmake -DINPUT_FILE=app_loader.exe -DOUTPUT_FILE=template_exe.inc -P generate_embedded_template.cmake
...
if(NOT EXISTS "${INPUT_FILE}")
    message(WARNING "Template file not found: ${INPUT_FILE}")
    # 生成空的占位文件
    file(WRITE "${OUTPUT_FILE}" 
"// Template not available - build app_loader first
static const unsigned char template_exe_data[] = {};
static const size_t template_exe_size = 0;
")
    return()
endif()
...
string(APPEND OUTPUT_CONTENT "static const unsigned char template_exe_data[] = {\n    ")
...
string(APPEND OUTPUT_CONTENT "\n};\n\n")
string(APPEND OUTPUT_CONTENT "static const size_t template_exe_size = ${FILE_SIZE};\n")
