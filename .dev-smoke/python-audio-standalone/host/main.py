...
EMBEDDED_CONFIG = {
    "name": "python-audio-smoke",
    "purpose": "minimal",
    "runtime": "python",
    "window": {"title": "MBink Python Audio Smoke", "width": 760, "height": 300, "resizable": True},
}
...
os.environ.setdefault("MBINK_AUDIO_DEBUG", "1")
audio_stem = Path(sys.executable if getattr(sys, "frozen", False) else __file__).stem or "app"
audio_log_path = PROJECT_ROOT / f"{audio_stem}.audio.log"
os.environ.setdefault("MBINK_AUDIO_DEBUG_FILE", str(audio_log_path))
