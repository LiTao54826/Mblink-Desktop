// examples/codemirror6/node_modules/@marijn/find-cluster-break/src/index.js
var rangeFrom = [];
var rangeTo = [];
(() => {
...
// examples/codemirror6/node_modules/@codemirror/state/dist/index.js
...
// examples/codemirror6/node_modules/style-mod/src/style-mod.js
var C = "\u037C";
...
// examples/codemirror6/node_modules/w3c-keyname/index.js
var base = {
  8: "Backspace",
  9: "Tab",
  10: "Enter",
...
// examples/codemirror6/node_modules/crelt/index.js
function crelt() {
  var elt = arguments[0];
...
// examples/codemirror6/node_modules/@codemirror/view/dist/index.js
...
function rectanglesForRange(view, className, range) {
  ...
  function drawForLine(from2, to2, line) {
    ...
    function addSpan(from3, fromOpen, to3, toOpen, dir) {
      ...
      // DEBUG: 记录最后一行的调试信息
      if (line.from === 24 && line.to === 35) {
        console.log(`[drawForLine DEBUG] line 3: from3=${from3}, to3=${to3}, fromOpen=${fromOpen}, toOpen=${toOpen}`);
        console.log(`  fromCoords: left=${fromCoords.left.toFixed(2)}, right=${fromCoords.right.toFixed(2)}`);
        console.log(`  toCoords: left=${toCoords.left.toFixed(2)}, right=${toCoords.right.toFixed(2)}`);
        console.log(`  leftSide=${leftSide.toFixed(2)}, rightSide=${rightSide.toFixed(2)}`);
        console.log(`  pushed: [${horizontal[horizontal.length-2].toFixed(2)}, ${horizontal[horizontal.length-1].toFixed(2)}]`);
      }
    }
    let start = from2 !== null && from2 !== void 0 ? from2 : line.from, end = to2 !== null && to2 !== void 0 ? to2 : line.to;
    // DEBUG: 记录最后一行的参数
    if (line.from === 24 && line.to === 35) {
      console.log(`[drawForLine DEBUG] line 3 params: from2=${from2}, to2=${to2}, start=${start}, end=${end}`);
      console.log(`  visibleRanges:`, view.visibleRanges.map(r => `${r.from}-${r.to}`).join(', '));
    }
    ...
    // DEBUG: 记录最后一行的最终horizontal数组
    if (line.from === 24 && line.to === 35) {
      console.log(`[drawForLine DEBUG] line 3 final horizontal: [${horizontal.map(h => h.toFixed(2)).join(', ')}]`);
    }
...
// examples/codemirror6/node_modules/@lezer/common/dist/index.js
...
// examples/codemirror6/node_modules/@lezer/highlight/dist/index.js
var nextTagID = 0;
var Tag = class _Tag {
  /**
  @internal
...
// examples/codemirror6/node_modules/@codemirror/language/dist/index.js
var _a;
...
// examples/codemirror6/node_modules/@codemirror/commands/dist/index.js
...
// examples/codemirror6/node_modules/@codemirror/search/dist/index.js
...
// examples/codemirror6/node_modules/@codemirror/autocomplete/dist/index.js
...
// examples/codemirror6/node_modules/@codemirror/lint/dist/index.js
...
// examples/codemirror6/node_modules/codemirror/dist/index.js
...
// examples/codemirror6/node_modules/@lezer/lr/dist/index.js
...
// examples/codemirror6/node_modules/@lezer/javascript/dist/index.js
var noSemi = 316;
var noSemiType = 317;
var incdec = 1;
var incdecPrefix = 2;
...
// examples/codemirror6/node_modules/@codemirror/lang-javascript/dist/index.js
var snippets = [
...
// examples/codemirror6/node_modules/@codemirror/theme-one-dark/dist/index.js
var chalky = "#e5c07b";
var coral = "#e06c75";
var cyan = "#56b6c2";
var invalid = "#ffffff";
