...
public:
    ...
    std::shared_ptr<TextAreaEditState> GetEditState() const { return edit_state_; }
    ...
    void MarkScrollToCursor() { needs_scroll_to_cursor_ = true; }
    void RequestTextAreaRepaint();
...
private:
    friend class TextAreaEditingController;
    ...
    std::shared_ptr<TextAreaEditState> edit_state_;  // textarea 编辑状态
