...
public:
    ...
    /**
     * @brief 判断节点是否连接到文档树
     * @return 如果沿父链可追溯到 Document 节点则返回 true
     */
    bool IsConnected() const;

    /**
     * @brief 比较另一个节点相对当前节点的位置
     * @param other 要比较的节点
     * @return DOM compareDocumentPosition bitmask
     */
    uint32_t CompareDocumentPosition(std::shared_ptr<Node> other) const;
