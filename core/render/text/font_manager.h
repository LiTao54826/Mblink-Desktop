...
public:
    ...
    /**
     * @brief 获取符号字体的typeface
     * @return 符号字体的typeface
     */
    sk_sp<SkTypeface> GetSymbolTypeface();
     ...
     * @return 符号字体
     */
    SkFont GetSymbolFont(float size = 16.0f);
...
private:
    ...
    sk_sp<SkTypeface> symbol_typeface_;                             ///< 符号字体
