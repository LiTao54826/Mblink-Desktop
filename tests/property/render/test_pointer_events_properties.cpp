...
TEST_F(PointerEventsPropertyTest, PointerEventsNoneSkipsElementInHitTest) {
    ...
    for (int i = 0; i < NUM_ITERATIONS; ++i) {
        ...
        // Perform hit test
        HitTestResult result = hit_testing.HitTestRenderObject(parent, test_x, test_y, 0, 0);
...
TEST_F(PointerEventsPropertyTest, PointerEventsInheritance) {
    ...
    for (int i = 0; i < NUM_ITERATIONS; ++i) {
        ...
        // Perform hit test
        HitTestResult result = hit_testing.HitTestRenderObject(grandparent, test_x, test_y, 0, 0);
...
TEST_F(PointerEventsPropertyTest, PointerEventsNonePassesThroughToElementsBelow) {
    ...
    for (int i = 0; i < NUM_ITERATIONS; ++i) {
        ...
        // Perform hit test
        HitTestResult result = hit_testing.HitTestRenderObject(root, test_x, test_y, 0, 0);
