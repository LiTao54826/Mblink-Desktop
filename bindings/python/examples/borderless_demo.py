...
<body>
  <div class="window-frame">
    ...
    <div class="footer">MBlink Python Borderless Window</div>
  </div>
</body>
</html>
""")
...
# cd D:\code\C\MBlink\bindings\python
# pip install -e .
# pyinstaller -F examples\borderless_demo.py --add-binary="mblink\bin\mblink.dll;mblink\bin"