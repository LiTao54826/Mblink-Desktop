...
<head>
  <meta charset="utf-8" />
  <title>MBlink Rust Tray Demo</title>
  <style>
...
<body>
  <div class="window-frame">
    <div class="titlebar">
      ...
      <span class="titlebar-text">MBlink Rust Tray Demo</span>
      <div class="menubar">
    ...
    <div class="footer">MBlink Rust Borderless Tray Example</div>
  </div>
</body>
</html>
"#;
...
fn main() -> mblink::Result<()> {
    ...
    app.load_html(HTML)?;
    app.create_tray("MBlink Rust Tray Demo")?;
        ...
        app.on_tray_menu(move |payload| {
            ...
            match item_id {
                "show" => {
                    ...
                    handle.set_title("MBlink Rust Tray Demo")?;
                }
                "toggle_top" => {
                ...
                "about" => {
                    handle.show_main_window()?;
                    handle.set_title("MBlink Rust Tray Demo - About")?;
                    println!("MBlink Rust tray example");
                }
                "quit" => {
