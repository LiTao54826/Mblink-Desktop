...
func callbackJSONResult(value any, err error) *C.char {
	...
	return C.mbink_copy_string(ctext)
}

//export go_mbink_bind_trampoline
func go_mbink_bind_trampoline(argsJSON *C.char, userData unsafe.Pointer) *C.char {
	id := uintptr(userData)
...
//export go_mbink_bind_async_trampoline
func go_mbink_bind_async_trampoline(argsJSON *C.char, userData unsafe.Pointer) *C.char {
	id := uintptr(userData)
	callbackRegistry.RLock()
...
//export go_mbink_state_watch_trampoline
func go_mbink_state_watch_trampoline(name *C.char, valueJSON *C.char, userData unsafe.Pointer) {
	callbackRegistry.RLock()
...
//export go_mbink_resize_trampoline
func go_mbink_resize_trampoline(width C.int, height C.int, userData unsafe.Pointer) {
	callbackRegistry.RLock()
...
//export go_mbink_void_trampoline
func go_mbink_void_trampoline(userData unsafe.Pointer) {
	callbackRegistry.RLock()
...
//export go_mbink_bool_trampoline
func go_mbink_bool_trampoline(userData unsafe.Pointer) C.bool {
	callbackRegistry.RLock()
...
//export go_mbink_update_trampoline
func go_mbink_update_trampoline(deltaTime C.float, userData unsafe.Pointer) {
	callbackRegistry.RLock()
